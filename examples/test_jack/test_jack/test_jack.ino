// This program demonstrates usage of the pg::Jack class to read/write values and get/set 
// the status of the Arduino's gpio pins. See <components/Jack.h> for list of built-in
// Jack commands.
...
void jackCommand(float f)
{
  ...
  // Edit platform.txt file and add/change this line:
