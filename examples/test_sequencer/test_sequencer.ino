...
// Handles Sequencer callbacks (not strictly necessary).
...
// Sequencer object.
Sequencer seq(events, &sequencer_cb, true); // If callbacks not used, then substitute nullptr for the callback function. 
